...
require_once("lib/esb/rabbit_send.php");
//require_once("./rabbit_receive.php");

//echo $conf_dbhost . " " . $conf_dbuser . " " . $conf_dbpass . " " . $conf_dbdb;
db_connect($conf_dbhost,$conf_dbuser,$conf_dbpass,$conf_dbdb);
//sendMessage("Ovo je nasa prva custom poruka");
...
<p>&nbsp;</p>
<p>&nbsp;</p>
<p align="center">Copyright (c) 2006-2020 <a href="static/doc/CREDITS.txt">Vedran Ljubović i drugi</a><br>Elektrotehnički fakultet Sarajevo</p>
